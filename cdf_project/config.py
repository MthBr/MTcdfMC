...
if _local_dir:
    ...
    data_origianl_dir = Path(__file__).resolve().parents[4].joinpath('CDF Code','data')

else:
    data_dir = Path(__file__).resolve().parents[4].joinpath('Projects','CDF Code', 'data')
    raw_data_dir = Path(__file__).resolve().parents[4].joinpath('Projects', 'CDF Code', 'data', 'raw')
    reportings_dir = Path(__file__).resolve().parents[4].joinpath('Projects', 'CDF Code', 'reports')
    log_dir = Path(__file__).resolve().parents[4].joinpath('Projects', 'CDF Code', 'data', 'log_files')
